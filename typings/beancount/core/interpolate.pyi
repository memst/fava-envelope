...
def is_tolerance_user_specified(tolerance): # -> bool:
...
def compute_residual(postings): # -> Inventory:
...
def infer_tolerances(postings, options_map, use_cost=...): # -> ImmutableDictWithDefault:
...
def get_residual_postings(residual, account_rounding): # -> list[Posting]:
...
def compute_entries_balance(entries, prefix=..., date=...): # -> Inventory:
...
def compute_entry_context(entries, context_entry, additional_accounts=...): # -> tuple[defaultdict[Any, Inventory], defaultdict[Any, Inventory]]:
