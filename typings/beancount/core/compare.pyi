...
CompareError = ...
IGNORED_FIELD_NAMES = ...
def stable_hash_namedtuple(objtuple, ignore=...): # -> str:
...
def hash_entry(entry, exclude_meta=...): # -> str:
...
def hash_entries(entries, exclude_meta=...): # -> tuple[dict[Any, Any], list[Any]]:
...
def compare_entries(entries1, entries2): # -> tuple[bool, list[Any], list[Any]]:
...
def includes_entries(subset_entries, entries): # -> tuple[bool, list[Any]]:
...
def excludes_entries(subset_entries, entries): # -> tuple[bool, list[Any]]:
