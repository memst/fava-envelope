...
__copyright__ = ...
__license__ = ...
def align_position_strings(strings): # -> tuple[list[Any], int]:
...
class EntryPrinter:
    ...
    def Transaction(self, entry, oss): # -> None:
        ...
    
    def render_posting_strings(self, posting): # -> tuple[Any, str | Any, str]:
    ...
    def Posting(self, posting, oss): # -> None:
        ...
    
    def Balance(self, entry, oss): # -> None:
        ...
    
    def Note(self, entry, oss): # -> None:
        ...
    
    def Document(self, entry, oss): # -> None:
        ...
    
    def Pad(self, entry, oss): # -> None:
        ...
    
    def Open(self, entry, oss): # -> None:
        ...
    
    def Close(self, entry, oss): # -> None:
        ...
    
    def Commodity(self, entry, oss): # -> None:
        ...
    
    def Price(self, entry, oss): # -> None:
        ...
    
    def Event(self, entry, oss): # -> None:
        ...
    
    def Query(self, entry, oss): # -> None:
        ...
    
    def Custom(self, entry, oss): # -> None:
        ...
    


def format_entry(entry, dcontext=..., render_weights=..., prefix=...): # -> str:
...
def print_entry(entry, dcontext=..., render_weights=..., file=...): # -> None:
...
def print_entries(entries, dcontext=..., render_weights=..., file=..., prefix=...): # -> None:
...
def print_errors(errors, file=..., prefix=...): # -> None:
