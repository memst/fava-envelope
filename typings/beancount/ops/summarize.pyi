...
__copyright__ = ...
__license__ = ...
def open(entries, date, account_types, conversion_currency, account_earnings, account_opening, account_conversions): # -> tuple[Any, int]:
...
def close(entries, date, conversion_currency, account_conversions): # -> tuple[Any | list[Any], int]:
...
def clear(entries, date, account_types, account_earnings): # -> tuple[Any, int]:
...
def open_opt(entries, date, options_map): # -> tuple[Any, int]:
    """Convenience function to open() using an options map.
    """
    ...

def close_opt(entries, date, options_map): # -> tuple[Any | list[Any], int]:
    """Convenience function to close() using an options map.
    """
    ...

def clear_opt(entries, date, options_map): # -> tuple[Any, int]:
    """Convenience function to clear() using an options map.
    """
    ...

def clamp(entries, begin_date, end_date, account_types, conversion_currency, account_earnings, account_opening, account_conversions): # -> tuple[Any | list[Any], int]:
...
def clamp_opt(entries, begin_date, end_date, options_map): # -> tuple[Any | list[Any], int]:
...
def cap(entries, account_types, conversion_currency, account_earnings, account_conversions): # -> list[Any]:
...
def cap_opt(entries, options_map): # -> list[Any]:
...
def summarize(entries, date, account_opening): # -> tuple[Any, int]:
...
def conversions(entries, conversion_account, conversion_currency, date=...): # -> list[Any]:
...
def create_entries_from_balances(balances, date, source_account, direction, meta, flag, narration_template): # -> list[Any]:
...
def balance_by_account(entries, date=..., compress_unbooked=...): # -> tuple[defaultdict[Any, Inventory], int]:
...
def get_open_entries(entries, date): # -> list[Any]:
